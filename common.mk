...
OPTEE_OS_CLEAN_COMMON_FLAGS ?= \
	$(OPTEE_OS_COMMON_EXTRA_FLAGS) \
	O=$(OPTEE_OS_OUT_PATH)

optee-os-clean-common: xtest-clean
	$(MAKE) -C $(OPTEE_OS_PATH) $(OPTEE_OS_CLEAN_COMMON_FLAGS) clean
	rm -rf $(OPTEE_OS_PATH)/$(OPTEE_OS_OUT_PATH)

OPTEE_CLIENT_COMMON_FLAGS ?= \
	CROSS_COMPILE=$(CROSS_COMPILE_NS_USER) \
	O=$(OPTEE_CLIENT_OUT_PATH)

optee-client-common:
	$(MAKE) -C $(OPTEE_CLIENT_PATH) $(OPTEE_CLIENT_COMMON_FLAGS)

OPTEE_CLIENT_CLEAN_COMMON_FLAGS ?= \
	CROSS_COMPILE=$(CROSS_COMPILE_NS_USER) \
	O=$(OPTEE_CLIENT_OUT_PATH)

optee-client-clean-common:
	$(MAKE) -C $(OPTEE_CLIENT_PATH) $(OPTEE_CLIENT_CLEAN_COMMON_FLAGS) clean
	rm -rf $(OPTEE_CLIENT_PATH)/$(OPTEE_CLIENT_OUT_PATH)
